...
async def get_history(
    ...
    history = await vector_store.get_chat_history(session_id=session_id, username=current_user)
...
async def get_sessions(
    ...
    sessions = await vector_store.get_user_sessions(username=current_user)
